...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	BufferedImage maze;
	final int frameWidth = 322;
	final int frameHeight = 322;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Minecraft - Zombie Sounds.wav"));
